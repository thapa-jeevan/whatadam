...
parser.add_argument('--approach', default='', type=str, required=True,
                    choices=['random', 'sgd', 'sgd-frozen', 'lwf', 'lfl', 'ewc', 'imm-mean', 'progressive', 'pathnet',
                             'imm-mode', 'sgd-restart', 'joint', 'hat', 'hat_adamw', 'hat_original', 'hat-test'], help='(default=%(default)s)')
...
elif args.approach == 'hat_adamw':
    from approaches import hat_adamw as approach
elif args.approach == 'hat_original':
...
appr = approach.Appr(net, nepochs=args.nepochs, lr=args.lr, lamb=args.lamb, args=args)
